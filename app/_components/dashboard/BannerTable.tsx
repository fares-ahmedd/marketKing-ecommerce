...
import placeholder from "@/public/temp.webp";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
    ...
    <section className="card">
      ...
      <table className="border border-main-text rounded-lg  w-full  max-w-[1080px] mx-auto max-sm:w-[500px] overflow-x-auto">
        ...
        <tbody className=" border-b border-second-text text-second-text rounded-lg ">
          <tr className="border-b grid grid-cols-3 p-2  overflow-hidden hover:bg-main-background items-center">
            <ModalImage
              image={<Image src={placeholder} alt="her" fill />}
              className="w-[95%] h-[100px]  relative"
              isInTable={true}
              modalId={"hi"}
            />
            <th className="border-custom-x">Test</th>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="center">
                  ...
                  <DropdownMenuItem
                    ...
                    asChild
                  >
                    <MyLink href={`/dashboard/products/`}>{t("Delete")}</MyLink>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </th>
